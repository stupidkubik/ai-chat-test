...
| --- | --- | --- | --- | --- | --- | --- | --- |
| D01 | на проверке | Дизайн-агент → координатор | `codex/d01-design` | `1201781`; `docs/ui/UI_SPEC.md`, `preview.html`, `desktop.png`, `mobile.png` | Chromium: 1440×900, 390×844, 320 px и 200 px без горизонтального скролла; фокус 3 px; Impeccable detect и исправления | [PR #1](https://github.com/stupidkubik/ai-chat-test/pull/1) открыт, merge ожидает проверки | Нужна проверка дизайна человеком перед merge и S02 |
