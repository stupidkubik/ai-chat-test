...
GitHub-доступ восстановлен 25.09.2026. Публичный [stupidkubik/ai-chat-test](https://github.com/stupidkubik/ai-chat-test) подключён как `origin`; `main` отправлена и является веткой по умолчанию. PR D01 открыт и ожидает проверки.
