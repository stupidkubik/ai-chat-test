...
- **Состояние и доступность:** снимок показывает историю `ol/li`, статус `role="status"`, подписанное поле и доступные кнопки. Ручной U04-проход ранее подтвердил Tab-порядок, disabled-состояние отправки и видимость формы на 390×320.
